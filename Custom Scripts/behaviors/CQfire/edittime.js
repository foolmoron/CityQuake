...
{
	return {
		"name":			"CQ Fire",			// as appears in 'add behavior' dialog, can be changed as long as "id" stays the same
		"id":			"CQfire",			// this is used to identify this behavior and is saved to the project; never change it
		"version":		"1.0",					// (float in x.y format) Behavior version - C2 shows compatibility warnings based on this
		"description":	"City Quake fire sprite",
		"author":		"foolmoron",
